...
if __name__ == "__main__":
    ...
    #img_vol = img_vol.flatten()
    subsample, subsample_factor = [ int(i) for i in  opts.subsample_list.split(',') ]
    
    BrainDist.wm_dist(img_vol, steps, maxima, starts, opts.mesh_fn, opts.matrix_fn, opts.surface_mask_fn, opts.example_fn, opts.density_fn, np.int64(opts.label), opts.wm_search_depth, opts.max_threads, opts.example_vertex, subsample, subsample_factor,  opts.verbose  )
