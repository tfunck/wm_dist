...
static PyObject*  c_wm_dist_calculate(PyObject* self,  PyObject* args) {
...
static char c_wm_dist_docs[] = "wm_dist( ): Calculate minimum distances through WM\n";
//static char surf_dist_docs[] = "surf_dist( ): Calculate minimum geodesic distance across surface\n";

static PyMethodDef c_wm_dist_funcs[] = {
  {"calculate", (PyCFunction) c_wm_dist_calculate, METH_VARARGS, c_wm_dist_docs},
